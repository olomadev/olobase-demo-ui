<template>
  <va-edit-layout :title="title">
    <employees-form :id="id" :item="item"></employees-form>
  </va-edit-layout>
  ...
  >
    ...
    <v-tab value="3">UpdateHandler</v-tab>
    <v-tab value="4">FindOneByIdHandler</v-tab>
    <v-tab value="5">Model</v-tab>
  </v-tabs>
  ...
  <v-window v-model="tab">
    ...
    <v-window-item eager value="3">
      <v-card>
        <v-card-text>
          <v-btn class="btn-copy">{{ $t("va.actions.copy") }}</v-btn>
          <pre><code class="language-php">{{ updateHandler }}</code></pre>
        </v-card-text>
      </v-card>
    </v-window-item>
    ...
    <v-window-item eager value="4">
      <v-card>
        <v-card-text>
          <v-btn class="btn-copy">{{ $t("va.actions.copy") }}</v-btn>
          <pre><code class="language-php">{{ findOneByIdHandler }}</code></pre>
        </v-card-text>
      </v-card>
    </v-window-item>
